...
% MODEL PARAMETERS UKF ESTIMATE FOR PREDATOR PREY MODEL DUAL UKF
%
%
% INPUT: 
%       param0: model state variables only 
%       P_param_0: covariance matrix      
%       Q: process noise matrix 
%       R: measurement noise matrix 
%       obsAll: observable data
%       InferenceDS: saved information structure 
%
% OUTPUT
%       param_hat: estimated state variables for the next time step 
%       P_param_hat: updated covariance matrix 



function [param_hat,P_param_hat] = UKF_Params(param0, P_param_0,Q,R, obsAll,  InferenceDS, Xprev, numLatent)
