...
[finalpar(k,:),fval,exitflag(k),output] =...
    fminsearch('Lor_loglikMultiP2',par0,options,y,x00,P00,InfDS2,pNoise,oNoise);
...
%Xh_ukf(:,1) = xavg(:,1);
starttime = cputime;
[Xh_ukf, Px_ukf, xh_, Px_, yh_, inov, Py, KG, lik,Pxall]= ukfaddmultiP(x00,P00,pNoise, oNoise, y,[],[],InfDS2,0,1,x); 
