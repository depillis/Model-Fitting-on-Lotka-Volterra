...
% Date: June, 3, 2021
% Change covariance matrix to make it simpler 
% Use Mahafy's dataset 
% Compare with Mahafy's estimated parameters 
...
% June 7th 
% REU2020 student code stated the following:  
% truepar= [0.62526 0.6607 0.1896 0.0468]; 
% we did not know what is the source of these values 
% An modified to: 
% truepar: estimated parameters obtained from Mahafy's study
...
% Load dataset found in Mahafy
% https://jmahaffy.sdsu.edu/courses/f09/math636/lectures/lotka/qualde2.html
% extract time data, prey and predator data

HLData = load('HaresLynxData_AD.mat');  
%rawData = HLData.Mahafy;
rawData = HLData.Hudson_Bay;
