...
if (nargin ~= 8) 
    error(' [ ukf ] Number of input arguments does not match.'); 
end %checking the number of arguments put in 
...
for i=1:NT
    ...
    for z = 1:nsp
        [~, solutions] = ode45(@(t, y) Lotka_Volterra_Model(t, y, Z(3:6,z)),...
            tspan, Z(1:2,z), options); %solve ode with ode45
